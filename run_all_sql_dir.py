...
parser.add_option("-s", "--sql", dest="sqlfilename",
                  default=None,
                  help="Name of summary SQL file ")
...
elif sqlfilename is not None:
    filedescriptor = open(str(sqlfilename), 'w')
    filedescriptor.write(SqlQueryALL + '\n')
    filedescriptor.close()
    logging.info( 'SQL script: ' + str(sqlfilename) + ' was created.')
